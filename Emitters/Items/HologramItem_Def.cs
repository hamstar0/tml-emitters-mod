...
namespace Emitters.Items {
	public partial class HologramItem : ModItem {
		...
		public override void ModifyTooltips( List<TooltipLine> tooltips ) {
			tooltips.Insert( 0, new TooltipLine(this.mod, "HologramUI", "[c/00FF00:Right-click in inventory to adjust settings]") );
			tooltips.Insert( 1, new TooltipLine(this.mod, "HologramToggle", "[c/00FF00:Left-click in world to toggle activation]") );
			tooltips.Insert( 2, new TooltipLine(this.mod, "HologramRemove", "[c/00FF00:Right-click in world to remove]") );
